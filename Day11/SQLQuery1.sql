...
INSERT INTO Departments Values ('Electrical & Electronics Engineering','EEE')
...
INNER JOIN Districts As d ON d.ID = s.DistrictID
...
UPDATE Students  SET RollNo = '',Name = '', Age = '', Address = '', DistrictID = WHERE ID = 